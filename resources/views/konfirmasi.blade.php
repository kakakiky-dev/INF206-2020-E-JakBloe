...
<br>
                    ...
                    <p class="f_400 w_color f_size_16 l_height26 text-center">Terima kasih sudah melakukan pemesanan!<br>Silahkan lakukan pembayaran ke nomor rekening berikut:</p>
<div class="col-md-16 text-center">
<div class="btn btn-light">
<span class="f_400 b_color f_size_16 l_height26 text-center"><i class="fas fa-dollar-sign"></i>  3908-01-008813-53-9</span>
</div>
<p class="f_400 w_color f_size_16 l_height26 text-center" style="margin-top: 10px;">A/N NAZIRA REZKY AFIFAH</p>
<img src="img/chpembayaran.png" alt="Pembayaran" style="width:20%;height:20%; margin-top: -50px;">
<form action="/gambarkonfirmasi" class="login-form sign-in-form" method="post" enctype="multipart/form-data">
@csrf
...
@foreach($isi as $i)
<button class="btn btn-lg btn-success btn-block" type="submit" name="search" value="{{$i->id}}" style="border-radius: 40px; width: 300px; padding: 10px;margin: 5px auto;">Konfirmasi Pembayaran</button>
@endforeach
<button class="btn btn-lg btn-success btn-block" type="submit" style="border-radius: 40px; width: 300px; padding: 10px;margin: 5px auto;">Batalkan Pembayaran</button>
</form>
<br>
<br>
<br>
