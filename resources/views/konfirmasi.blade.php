...
<br>
<input class="form-group text_box text-white text-center" type="file" id="file">
</div>

<button class="btn btn-lg btn-success btn-block" type="submit" style="border-radius: 40px; width: 300px; padding: 10px;margin: 5px auto;">Konfirmasi Pembayaran</button>
